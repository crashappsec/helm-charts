...
OCULAR_ENV_FILE='' make -C "$OCULAR_DI_REPO_ROOT" clean-helm
...
OCULAR_ENV_FILE='' OCULAR_DEFAULTS_VERSION=$(git -C "$OCULAR_DI_REPO_ROOT" tag --sort=-creatordate | head -n 1) make -C "$OCULAR_DI_REPO_ROOT" build-helm
