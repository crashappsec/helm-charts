...
github: |
  image: ghcr.io/crashappsec/ocular-default-crawlers:v0.1.0
  secrets:
      - name: github-token
        mountType: envVar
...
docker: |
  image: ghcr.io/crashappsec/ocular-default-downloaders:v0.1.0
  secrets:
...
s3: |
  image: ghcr.io/crashappsec/ocular-default-uploaders:v0.1.0
  secrets:
